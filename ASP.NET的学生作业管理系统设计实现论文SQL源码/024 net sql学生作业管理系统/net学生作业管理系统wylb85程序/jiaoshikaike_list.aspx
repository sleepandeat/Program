<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jiaoshikaike_list.aspx.cs" Inherits="jiaoshikaike_list" %>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="删除">
                                	<ItemTemplate>
                                    	<a href='delid.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=jiaoshikaike&npage=jiaoshikaike_list.aspx' onclick="return confirm('确定要删除？')">删除</a>
                               		</ItemTemplate>
								<HeaderStyle Width="50px" />
