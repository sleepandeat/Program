<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jiaoshikaike_list2.aspx.cs" Inherits="jiaoshikaike_list2" %>
            ...
            <tbody>
                ...
                <tr class="tr1">
                    <td style="padding-left: 5px; height: 25px">
                        &nbsp; 课程：<asp:TextBox ID=kecheng runat="server" style='border:solid 1px #000000; color:#666666' Width="80px"></asp:TextBox>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="修改">
                               		<ItemTemplate>
                                    	<a href='jiaoshikaike_updt.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>'>修改</a>
                                	</ItemTemplate>
								<HeaderStyle Width="50px" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="删除">
                                	<ItemTemplate>
                                    	<a href='delid.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=jiaoshikaike&npage=jiaoshikaike_list2.aspx' onclick="return confirm('确定要删除？')">删除</a>
                               		</ItemTemplate>
								<HeaderStyle Width="50px" />
                                </asp:TemplateColumn>
