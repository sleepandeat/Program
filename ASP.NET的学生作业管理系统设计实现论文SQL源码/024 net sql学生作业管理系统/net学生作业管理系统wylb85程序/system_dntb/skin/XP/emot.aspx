...
<td>
    ...
    <table width="100%">
        <tr>
            <td style="width: 80%"><input id="emoturl" size="40" value="<%=ResourceManager.GetString("emotpath")%>" onclick="this.value=''" style="width: 160px" type="text" />&nbsp;
          <input name="close" type="button" value='<%=ResourceManager.GetString("insert")%>' onclick="javascript:insertEmot(emoturl.value);parent.popMenu2.hide();" /></td>
            <td style="width:20%" align=right><asp:Menu ID="Menu1" Width="70px" runat="server" Orientation="Horizontal" StaticEnableDefaultPopOutImage="False"  OnMenuItemClick="Menu1_MenuItemClick" >
<Items>
